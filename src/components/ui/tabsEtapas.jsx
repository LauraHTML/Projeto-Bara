...
function Tabs({
  ...
  return (
    <TabsPrimitive.Root
      data-slot="tabs"
      className={cn("grid md:grid-rows-1 grid-cols-1 md:grid-cols-5 w-fit", className)}
      {...props} />
  );
}
...
function TabsList({
  ...
  return (
    <TabsPrimitive.List
      data-slot="tabs-list"
      className={cn(
        "text-foreground grid grid-cols-2 grid-rows-2 md:grid-cols-1 md:grid-rows-4 gap-3 h-fit md:w-fit col-span-1 rounded-lg p-[4px]",
        className
      )}
      {...props} />
  );
...
function TabsContent({
  ...
  return (
    <TabsPrimitive.Content
      ...
      className={cn("flex-1 outline-none col-span-4", className)}
      {...props} />
  );
}
